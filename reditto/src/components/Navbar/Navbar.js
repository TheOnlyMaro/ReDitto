      ...
      <div className="navbar-container">
        ...
        <div className="navbar-right">
          {!isLoggedIn ? (
            ...
            <>
              {/* Chat Icon */}
              <button className="navbar-icon-btn" aria-label="Chat" onClick={handleChatClick}>
              ...
              {/* Create Post Button */}
              <button className="navbar-icon-btn create-btn" aria-label="Create post" onClick={handleCreateClick}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Notifications */}
              <button className="navbar-icon-btn" aria-label="Notifications" onClick={handleNotificationsClick}>
